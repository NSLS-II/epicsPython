...
class epicsMotor:
   ...
   Virtual attributes:
      ...
      ---------        -----------------------      -----
      speed            Speed in revs/sec            .S
      urev             Units per revolution         .UREV
...
"""
   ...
   def __getattr__(self, attrname):
      ...
      elif (attrname == 'speed'):      return self.pvs['s'].getw()
      elif (attrname == 'urev'):      return self.pvs['urev'].getw()
   ...
   def __setattr__(self, attrname, value):
      ...
      elif (attrname == 'speed'):      self.pvs['s'].putw(value)
      elif (attrname == 'urev'):      self.pvs['urev'].putw(value)
